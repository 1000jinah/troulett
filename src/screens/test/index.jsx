...
const Test = () => {
  ...
  // 인풋 값 변경 시 실행되는 함수
  console.log(targetItemWinCount,totalSpentForTargetItem,excelFile,selectedTargetItemCount,selectedTargetItemTotalSpins,setTargetItem,"12121212")
      ...
      >
        ...
        >
          ...
          >
            ...
            <DefaultBox>
              <Typography sx={{ color: "#fafafa" }}>
               ...
               {selectedExcelItem && (
              <Input
                sx={{ fontSize: "2rem", color: "#fafafa" }}
                type="number"
                value={selectedExcelItem ? selectedExcelItem.excDownPrice:oneTimeAmount}
                onChange={(e) =>
            ...
            <DefaultBox>
              <Typography
                sx={{ fontWeight: "bold", fontSize: 16, color: "#fafafa" }}
              >
                등록 내역
              </Typography>
              <Box>
          ...
          <DefaultBox sx={{ margin: "20px", marginTop: "-10px" }}>
            ...
            >
              <Profile onSelectExcelItem={handleSelectExcelItem} />
            </Box>
          </DefaultBox>
        </Box>
        <>d</>
        ...
        >
          <p style={{ fontSize: "10px", color: "#3b3b3b", textAlign: "center" }}>
            1000jinah@gmail.com
          </p>
        </Box>
      </Box>
